...
var Angulartics2 = (function () {
    ...
    Angulartics2.prototype.trackLocation = function (location, router$$1) {
        var _this = this;
        router$$1.events.pipe(filter$1(function (event) { return event instanceof NavigationEnd; }), filter$1(function () { return !_this.settings.developerMode; })).subscribe(function (event) {
