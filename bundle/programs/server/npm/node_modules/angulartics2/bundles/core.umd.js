(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/router'), require('rxjs/operators/filter'), require('rxjs/ReplaySubject'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', '@angular/router', 'rxjs/operators/filter', 'rxjs/ReplaySubject', '@angular/platform-browser'], factory) :
...
}(this, (function (exports,common,core,router,filter,ReplaySubject,platformBrowser) { 'use strict';
...
var Angulartics2 = (function () {
    ...
    Angulartics2.prototype.trackLocation = function (location, router$$1) {
        var _this = this;
        router$$1.events.pipe(filter.filter(function (event) { return event instanceof router.NavigationEnd; }), filter.filter(function () { return !_this.settings.developerMode; })).subscribe(function (event) {
