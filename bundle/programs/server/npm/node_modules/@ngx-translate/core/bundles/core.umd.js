(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/observable/of'), require('rxjs/Observable'), require('rxjs/operators')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/observable/of', 'rxjs/Observable', 'rxjs/operators'], factory) :
	(factory((global['ngx-translate'] = global['ngx-translate'] || {}, global['ngx-translate'].core = {}),global.ng.core,global.Rx.Observable,global.Rx,global.Rx.Observable.prototype));
}(this, (function (exports,core,of,Observable,operators) { 'use strict';
...
exports.TranslateService = (function () {
            ...
            if (observables) {
                ...
                for (var _a = 0, key_2 = key; _a < key_2.length; _a++) {
                    ...
                    if (typeof mergedObs === "undefined") {
                        ...
                        mergedObs = mergedObs.pipe(operators.merge(obs));
                    }
                }
    ...
    TranslateService.prototype.stream = function (key, interpolateParams) {
        ...
        return this
            ...
            .pipe(operators.concat(this.onLangChange.pipe(operators.switchMap(function (event) {
